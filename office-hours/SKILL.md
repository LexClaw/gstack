...
Historical validation, generated learning, and spec-review-loop material was moved to `references/validation-log.md` on 2026-06-03 to keep this generated SKILL.md under the Hermes size gate.
...
5. **Ask: what's your goal with this?** Use the archived question flow in `references/validation-log.md` if needed. In short, classify the session into Startup mode (startup or intrapreneurship) or Builder mode (hackathon, open source/research, learning, or having fun), then assess product stage when relevant.
...
### If TIER = regular or inner_circle (sessions 4+)

Lead with recognition, reflect accumulated signals across sessions, and update `~/.gstack/builder-journey.md` when applicable. See `references/validation-log.md` for the archived detailed tier copy and wording examples.
