...
Detailed system-audit command scaffolding was archived to `references/validation-log.md` on 2026-06-03. Preserve the invariant: inspect existing design docs, handoff notes, prior reviews, git history, and relevant code before reviewing the plan.
...
Detailed mode reference was archived to `references/validation-log.md` on 2026-06-03. Preserve the four modes: scope expansion, selective expansion, hold scope, and scope reduction.
